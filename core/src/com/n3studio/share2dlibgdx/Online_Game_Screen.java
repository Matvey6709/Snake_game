...
public class Online_Game_Screen implements Screen {
    ...
    public com.n3studio.share2dlibgdx.Snake snake;
    com.n3studio.share2dlibgdx.Bread bread;
    com.n3studio.share2dlibgdx.Touch touch;
    ServerUpdate serverUpdate;
    com.n3studio.share2dlibgdx.DeterminantSize size;
    ...
    Camera camera;
    com.n3studio.share2dlibgdx.PointUi pointUi;
    Joystick3 joystick;
    Stage stage;
    ...
    public Online_Game_Screen(final game gam, String namePlayer, final String namePlayerUn, final String nameGame, boolean wait, boolean check) {
        ...
        com.n3studio.share2dlibgdx.SoundPlayer.playMusic(Asset.MEMO_SOUND, true);
    }
                    ...
                    if (!f) {
                        ...
                        pointUi.end.addListener(new ChangeListener() {
                            ...
                            public void changed(ChangeEvent event, Actor actor) {
                                ...
                                com.n3studio.share2dlibgdx.SoundPlayer.stopMusic(Asset.MEMO_SOUND);
                                game.bluetoothLoaded.restartGame();
                            }
                        });
                    }
