...
public class Lobby extends BaseScreen {
    ...
    game game;  //https://2gis.ru/directions/points/%7C49.10832%2C55.796449%3B2956015536569026?m=54.545457%2C56.841027%2F7.34
    Stage stage;//https://2gis.ru/directions/points/%7C49.10832%2C55.796449%3B2956015536569026?m=10.846034%2C56.968831%2F7.34
    Texture t;  //https://yandex.ru/maps/54/yekaterinburg/?ll=60.583652%2C56.800494&mode=routes&rtext=56.800255%2C60.583603~56.800607%2C60.582677&rtt=mt&ruri=~&z=19.33
    Texture level;
    ...
    com.n3studio.share2dlibgdx.Сlassic_Game_Screen сlassic_game_screen;
    Levels_Game_Screen levels_game_screen;
    Leaderboard leaderboard;
    com.n3studio.share2dlibgdx.LeaderboardBluetooth leaderboardBluetooth;
...
//                    }
        ...
        ImageTextButton startGame3 = ImageTextButtonHandler.INSTANCE.createButtonWay("butL (2).png", "Игра в одиночку", 30, Color.WHITE, true);
...
//        TextButton startGame4 = new TextButton("Начать игру 4", setStyle(skin, 40));
        ImageTextButton startGame4 = ImageTextButtonHandler.INSTANCE.createButtonWay("butL (3).png", "Игра по Bluetooth", 30, Color.WHITE, true);
...
//            button2.setPosition(300, 70);
            text = LabelHandler.INSTANCE.createLabel("Нажми на ту часть змейки, которую хочешь поменять.", 35, Color.WHITE);
...
//            buttonM3.setVisible(false);
    ...
    public class SelectLevel {
        Image image;
        Image coverimage;//cover-image.png
        Table table2;
        Label labelLevel;
        ...
        public SelectLevel() {
            ...
            coverimage = new Image(new Texture("cover-image.png"));
            coverimage.getColor().a = 0.4f;
            ...
            coverimage.setSize(Gdx.graphics.getWidth(), Gdx.graphics.getHeight());
