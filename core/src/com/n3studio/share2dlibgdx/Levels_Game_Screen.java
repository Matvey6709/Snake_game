        ...
        switch (level) {
            case 0:
                for (int i = 0; i < 720 / 33 * 1.5; i++) {
                    ...
                    mapGames.boxes.add(new com.n3studio.share2dlibgdx.Cell(627, 33 * i, 33, 33));
                }
                break;
            case 1:
                ...
                for (int i = 0; i < 1280 / 33 * 1.5; i++) {
                    ...
                    mapGames.boxes.add(new com.n3studio.share2dlibgdx.Cell(33 * i, 363, 33, 33));
                }
                spawnX = 99;
                spawnY = 99;
            ...
            case 3:
                for (int i = 0; i < 40; i++) {
                    ...
                    mapGames.boxes.add(new com.n3studio.share2dlibgdx.Cell(660, 33 * i, 33, 33));
                }
                break;
            case 4:
                for (int i = 0; i < 25; i++) {
