...
public class Snake {
    ...
    com.n3studio.share2dlibgdx.ui.Joystick3 joystick3;
...
//        snaketailMy = new Texture("snakeTailMy.png");
    ...
    public void render(float delta) {
        ...
        for (int i = 0; i < cells.size() - 1; i++) {
            batch.draw(com.n3studio.share2dlibgdx.TexturesClass.i.textureS, cells.get(i).x, cells.get(i).y, cells.get(i).sizeX, cells.get(i).sizeY);
        }
...
//            }
    ...
    public void dispose() {
        com.n3studio.share2dlibgdx.TexturesClass.i.textureS.dispose();
        batch.dispose();
        com.n3studio.share2dlibgdx.TexturesClass.i.snakehead.dispose();
        com.n3studio.share2dlibgdx.TexturesClass.i.snakebody.dispose();
        com.n3studio.share2dlibgdx.TexturesClass.i.snakeheadMy.dispose();
        com.n3studio.share2dlibgdx.TexturesClass.i.snakebodyMy.dispose();
