...
public class BluetoothService {
    ...
    SendReceiveImage sendReceiveImage;
    ...
    public void sendImage(Bitmap bitmap) {
        //превращение из Texture в Bitmap
            ...
            if (!isInterrupted()) {
                ...
                while (true || run) {
                    try {
                        ...
                        System.out.println(bytes + " " + buffer.length);
...
//                    System.out.println("SEND");
    ...
    private class SendReceiveImage extends Thread {
        private final BluetoothSocket bluetoothSocket;
        private final InputStream inputStream;
        private final OutputStream outputStream;
        ...
        public SendReceiveImage(BluetoothSocket socket) {
            bluetoothSocket = socket;
            InputStream tempIn = null;
            OutputStream tempOut = null;
...
//                            handler.obtainMessage(STATE_MESSAGE_RECEIVED,numberOfBytes,-1,buffer).sendToTarget();
                            ...
                            Bitmap bitmap = BitmapFactory.decodeByteArray(buffer, 0, numberOfBytes);
